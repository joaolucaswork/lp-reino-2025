...
echo -e "\n${YELLOW}📋 Step 7: Pushing to remote...${NC}"
git push origin $DIST_BRANCH --force
echo -e "${GREEN}✅ Pushed to remote${NC}"

# Step 8: Return to original branch
echo -e "\n${YELLOW}📋 Step 8: Returning to ${CURRENT_BRANCH}...${NC}"
git checkout $CURRENT_BRANCH
echo -e "${GREEN}✅ Returned to ${CURRENT_BRANCH}${NC}"

# Step 9: Create git tag if version specified
if [ "$VERSION" != "latest" ]; then
    echo -e "\n${YELLOW}📋 Step 9: Creating version tag...${NC}"
